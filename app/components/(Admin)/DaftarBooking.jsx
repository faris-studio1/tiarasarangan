...
const DaftarBooking = () => {
  ...
  return (
    <div className="fixed left-0 top-16 bottom-10 right-0 md:left-64 pt-14 pb-6 md:pt-10 px-8 overflow-y-auto">
      ...
      {isEditing && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-80 flex justify-center items-center z-50 left-0 top-0 bottom-0 right-0 md:left-64 md:pt-10 p-10 overflow-auto">
          <div className="flex bg-white dark:bg-gray-700 rounded-xl shadow-lg">
            <div className="bg-gray-300 dark:bg-gray-900 rounded-bl-xl rounded-tl-xl py-9 px-12 md:col-span-2">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-2xl font-bold text-center flex items-center justify-center text-gray-800 dark:text-gray-200">
                  <FaHotel className="text-yellow-500 mr-2" /> Denah Kamar
                </h2>
                <input
                  type="date"
                  id="selectedDate"
                  className="text-sm px-2 py-1 border border-gray-300 dark:border-gray-500 dark:bg-gray-600 dark:text-gray-200 rounded-md shadow-sm focus:ring-2 focus:ring-yellow-500 focus:outline-none transition duration-300 ease-in-out"
                  value={selectedDate}
              ...
              <div className="p-4 bg-gray-200 dark:bg-gray-700 rounded-xl mt-4 shadow-lg border-2 border-gray-400 dark:border-gray-500">
